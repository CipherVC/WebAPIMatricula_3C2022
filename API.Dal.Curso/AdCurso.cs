...
namespace API.Dal.Curso
{
    public class AdCurso : IAdCurso
    {
        ...
        {
            IDbConnection oConexion = null; IDbCommand oComando = manager.GetComando(); Dto.Curso.Salida.AgregarCurso resultado = new Dto.Curso.Salida.AgregarCurso();
        ...
        {
            IDbConnection oConexion = null; IDbCommand oComando = manager.GetComando(); Dto.Curso.Salida.EliminarCurso resultado = new Dto.Curso.Salida.EliminarCurso();
