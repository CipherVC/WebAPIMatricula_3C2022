...
public Dto.Estudiante.Salida.AgregarEstudiante AgregarEstudiante(Dto.Estudiante.Entrada.AgregarEstudiante pInformacion)
        {
            IDbConnection oConexion = null; IDbCommand oComando = manager.GetComando(); Dto.Estudiante.Salida.AgregarEstudiante resultado = new Dto.Estudiante.Salida.AgregarEstudiante();

            try
            {
                oConexion = manager.GetConexion(); oConexion.Open();

                oComando.Parameters.Add(manager.GetParametro("@Identificacion", pInformacion.Identificacion)); oComando.Parameters.Add(manager.GetParametro("@NombreCompleto", pInformacion.NombreCompleto)); oComando.Parameters.Add(manager.GetParametro("@CorreoElectronico", pInformacion.CorreoElectronico)); oComando.Parameters.Add(manager.GetParametro("@Estado", pInformacion.Estado));
        ...
        {
            IDbConnection oConexion = null; IDbCommand oComando = manager.GetComando(); Dto.Estudiante.Salida.EliminarEstudiante resultado = new Dto.Estudiante.Salida.EliminarEstudiante();
